    ...
    const work = [
        {
            ...
            icon: './assets/work-1.jpeg',
            description: 'ID Card Generator',
            link: 'https://id-card-generate.pages.dev/',
        },
        {
            name: 'Frontend project',
            icon: './assets/work-2.jpeg',
            description: 'Time watch',
            link: 'https://time-watch.pages.dev/',
        },
        {
            name: 'Frontend project',
            icon: './assets/work-3.jpeg',
            description: 'Todo lists',
            link: 'https://kuzxa-todolist.pages.dev/',
        },
        {
            name: 'Designing roadmap',
